...
public abstract class Predators extends Animal{
    ...
    public Predators(int posX, int posY, double weight, int speed) {
...
//        System.out.println("позиция животного :" +  this.posX + " " +this.posY);
    ...
    public boolean checkHerbivores(){
        return this.cell.herbivores.isEmpty();
    }
...
//        System.out.println(" уходит с ячейки: " + this.cell);
        Cell.island.get(posX + " " +posY).predators.remove(this);
...
//            System.out.println("текущая позиция животного: "+this.posX + " " + this.posY);
        ...
        Cell.island.get(posX + " " +posY).predators.add(this);
        this.cell = Cell.island.get(posX + " " + posY);
...
//
    ...
    public void death(){
        Cell.island.get(this.posX + " "+this.posY).predators.remove(this);
        this.cell = null;
        this.posX = 0;
        this.posY =0;
...
//            System.out.println(this.checkPlants());
            if (this.checkHerbivores() && this.checkPlants()) {
